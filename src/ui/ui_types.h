...
#define FFT_WATERFALL_HEIGHT 76

#define INFO_HEIGHT (DISPLAY_Y_PIXELS - HEADER_HEIGHT * 2 - FFT_WIDGET_HEIGHT - FFT_WATERFALL_HEIGHT - FFT_X_AXIS_HEIGHT - FFT_BAND_BAR_HEIGHT)
