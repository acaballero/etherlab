...
// Additional bar between FFT and X axis (band labels)
#define FFT_BAND_BAR_HEIGHT 14

// Keep overall layout stable by shrinking the waterfall to accommodate the new band bar.
#define FFT_WATERFALL_BASE_HEIGHT 90
#define FFT_WATERFALL_HEIGHT (FFT_WATERFALL_BASE_HEIGHT - FFT_BAND_BAR_HEIGHT)
...
#define WATERFALL_TOP (HEADER_HEIGHT + FFT_WIDGET_HEIGHT + FFT_BAND_BAR_HEIGHT + FFT_X_AXIS_HEIGHT)
