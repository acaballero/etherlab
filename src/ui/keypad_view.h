...
class KeypadView : public View {
 ...
 private:
   ...
   Button button_M{{button_w * (cols - 1), button_h * 1, button_w, button_h}, display, "M", C565_YELLOW};
   Button button_K{{button_w * (cols - 1), button_h * 2, button_w, button_h}, display, "k", C565_YELLOW};
   Button button_1{{button_w * (cols - 1), button_h * 3, button_w, button_h}, display, "x1", C565_YELLOW};

   Button button_close{{button_w * (cols - 1), button_h * 4, button_w, button_h}, display, "Cancel", C565_BLACK};

   Label text_widget{{0, 6, 3 * button_w, button_h - 7}};

   Label label_widget{{button_w * 3, 6, button_w, button_h - 7}};
