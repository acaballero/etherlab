...
protected:
    ...
    StatusWidget status_w{{0, DISPLAY_Y_PIXELS - HEADER_HEIGHT, DISPLAY_X_PIXELS, HEADER_HEIGHT}, &lcd};
    ...
    SMeterWidget smeter_w{{(DISPLAY_X_PIXELS-METER_WIDTH)/2, HEADER_HEIGHT + FFT_WIDGET_HEIGHT + FFT_WATERFALL_HEIGHT + 8, METER_WIDTH, TUNE_INFO_HEIGHT}, &lcd};
    PowerMeterWidget powmeter_w{{(DISPLAY_X_PIXELS-METER_WIDTH)/2, HEADER_HEIGHT + FFT_WIDGET_HEIGHT + FFT_WATERFALL_HEIGHT + 8, METER_WIDTH, TUNE_INFO_HEIGHT}, &lcd};
    ...
    FrequencyWidget frequency_w{{DISPLAY_X_PIXELS / 2 + 20, 0, DISPLAY_X_PIXELS / 2 - 20, HEADER_HEIGHT}, &lcd};
