...
class MainView : public View {
  ...
  protected:
    ...
    SMeterWidget smeter_w{{0, HEADER_HEIGHT + FFT_WIDGET_HEIGHT + FFT_WATERFALL_HEIGHT + 8, METER_WIDTH, METERS_HEIGHT}, &lcd};
    ...
    PowerMeterWidget powmeter_w{{0, HEADER_HEIGHT + FFT_WIDGET_HEIGHT + FFT_WATERFALL_HEIGHT + 8, METER_WIDTH, METERS_HEIGHT}, &lcd};
