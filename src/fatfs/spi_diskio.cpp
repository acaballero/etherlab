...
DSTATUS SPI_initialize(
    ...
    return BSP_SPI_initialize(pdrv);
    /* USER CODE END INIT */
}
...
DRESULT SPI_read(
    ...
    return BSP_SPI_read(pdrv, buff, sector, count);
    /* USER CODE END READ */
}
...
DRESULT SPI_write(
    ...
    /* USER CODE HERE */
    return BSP_SPI_write(pdrv, buff, sector, count);
    /* USER CODE END WRITE */
}
...
DRESULT SPI_ioctl(
    ...
    return BSP_SPI_ioctl(pdrv, cmd, buff);
    /* USER CODE END IOCTL */
}
