...
#define FFT_WATERFALL_MIN_REFRESH_PERIOD_MS 50
...
typedef struct {
    ...
    int maxAmpl = (2 / 3.3) * MAX_ADC_VALUE; // 2V peak to peak considering inputs to
    ...
    uint16_t waterfall_pixels_per_second = 1000 / (FFT_WATERFALL_MIN_REFRESH_PERIOD_MS * 2);
