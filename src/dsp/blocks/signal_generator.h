...
enum SIGNAL_SHAPE {
    SIGNAL_SHAPE_SIN, SIGNAL_SHAPE_SAW_UP, SIGNAL_SHAPE_SAW_DOWN, SIGNAL_SHAPE_TRI
};


class SignalGenerator : public Output {
...
public:
    ...
    SignalGenerator(uint32_t f, uint32_t sr, SIGNAL_SHAPE shape) : tone_shape{shape},
                                                                   frequency{f},
                                                                   sample_rate(sr) { init(); };
