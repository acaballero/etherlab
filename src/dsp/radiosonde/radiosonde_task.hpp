...
class RadiosondeTask : public Task {
  public:
    RadiosondeTask();
  ...
  private:
    ...
    PacketBuilder<BitPattern, NeverMatch, FixedLength> packet_builder_fsk_9600_Meteomodem{
        {0b00110011001100110101100110110011, 32, 1}, {}, {88 * 2 * 8}, [this](const baseband::Packet &packet) {
    ...
    BasebandThread baseband_thread{baseband_fs, this, baseband::Direction::Receive, /*auto_start*/ false};
