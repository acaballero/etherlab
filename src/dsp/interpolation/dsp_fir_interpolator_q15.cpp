...
template class DspFIRInterpolatorQ15Base<FIR_INTERPOLATOR_BASEBAND_TAPS, adc_type>;
template class DspFIRInterpolatorQ15<FIR_INTERPOLATOR_BASEBAND_TAPS>;
 ...
 */
template <int TAPS>
void DspFIRInterpolatorQ15<TAPS>::interpolate(buffer_t<adc_type> &src, buffer_t<adc_type> &dst, uint8_t start, uint8_t n_channels, int start_dst) {
...
template <int TAPS> void DspFIRInterpolatorQ15<TAPS>::interpolate(buffer_t<complex_t> &src, adc_type *dst_i, adc_type *dst_q) {
...
template <int TAPS> void DspFIRInterpolatorQ15<TAPS>::interpolate(buffer_t<adc_type> &src, buffer_t<adc_type> &dst) {
...
template <int TAPS> void DspFIRInterpolatorQ15<TAPS>::interpolate(adc_type *src_i, adc_type *src_q, adc_type *dst_i, adc_type *dst_q, size_t n_samples) {
...
template <int TAPS> void DspFIRInterpolatorQ15<TAPS>::interpolate(adc_type *src_i, adc_type *src_q, buffer_t<complex_t> &dst, size_t n_samples) {
...
template <int TAPS> bool DspFIRInterpolatorQ15<TAPS>::init() {

    bool b = DspFIRInterpolatorQ15Base<TAPS, adc_type>::init();
