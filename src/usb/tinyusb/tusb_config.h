 ...
 * Composite device: CDC + MSC + Audio (mono for WSJT-X)
 */
...
//------------- Audio Configuration -------------//
// IMPORTANT: WSJT-X needs MONO audio, not stereo I/Q

// Microphone (RX - Radio to PC)
#define CFG_TUD_AUDIO_FUNC_1_N_CHANNELS_RX                    1  // MONO for WSJT-X
#define CFG_TUD_AUDIO_FUNC_1_N_BYTES_PER_SAMPLE_RX            2  // 16-bit
#define CFG_TUD_AUDIO_FUNC_1_RESOLUTION_RX                    16
#define CFG_TUD_AUDIO_FUNC_1_SAMPLE_RATE                      48000

// Speaker (TX - PC to Radio)
#define CFG_TUD_AUDIO_FUNC_1_N_CHANNELS_TX                    1  // MONO for WSJT-X
