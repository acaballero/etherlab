 ...
 * Rabeeh Khoury <rabeeh@solid-run.com>i
 *
 ...
 * [2021-09-22] Timestamp:                                          2022-01-27
 * 00:41:20 GMT+01:00
 *
...
si5351b_revb_register_t const si5351b_revb_registers[] = {{0x0002, 0x33},
                                                          //  { 0x0003, 0x00 },
                                                          {0x0004, 0x10},
                                                          {0x0007, 0x01},
                                                          {0x000F, 0x00},
 ...
 * ========
 * Part:               Si5351B
 * Project File:       D:\Angel Dust\Documents\Si5351B-RevB-Project.slabtimeproj
 * Created By:         ClockBuilder Pro v4.1 [2021-09-22]
 * Timestamp:          2022-01-27 00:41:20 GMT+01:00
 *
 * Design Rule Check
 * =================
 * Errors:
 ...
 * 0x0034[17:0]  MS1_P1          928                0x003A0
 ...
 * 0x00A2[21:0]  VCXO_PARAM      379699             0x05CB33
...
class Si5351 {
 public:
   ...
   uint8_t set_ms(enum si5351_clock, struct Si5351RegSet, uint8_t, uint8_t,
                  uint8_t);
   ...
   struct Si5351Status dev_status = {
       .SYS_INIT = 0, .LOL_B = 0, .LOL_A = 0, .LOS = 0, .REVID = 0};
   struct Si5351IntStatus dev_int_status = {
       .SYS_INIT_STKY = 0, .LOL_B_STKY = 0, .LOL_A_STKY = 0, .LOS_STKY = 0};
   enum si5351_pll pll_assignment[8];
   uint64_t clk_freq[8];
   bool output_enabled[8];
   Si5351RegSet clk_ms[8];
   uint64_t plla_freq;
   uint64_t pllb_freq;
 ...
 private:
   uint64_t pll_calc(enum si5351_pll, uint64_t, struct Si5351RegSet *, int32_t,
                     uint8_t);
