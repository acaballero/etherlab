...
#define ADF4351_LD_PIN GPIO_PIN_4
#define ADF4351_LD_GPIO_PORT GPIOE
#define ADF4351_SPI_HANDLE hspi4 // Defined in the parent project
...
#define ADF4350_REG2_NOISE_MODE(x)				(uint32_t)((uint64_t)(x) << 29)
