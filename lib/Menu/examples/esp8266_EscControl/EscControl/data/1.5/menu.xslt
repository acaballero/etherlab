  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <!-- <script src="{$auxFilesSrc}/jquery-3.3.1.min2.js"></script> -->
        <script
        ...
        <!-- <link href="{$auxFilesSrc}/bootstrap.min2.css" rel="stylesheet"/>
        <script src="{$auxFilesSrc}/bootstrap.min2.js"></script> -->
        <link href="{$auxFilesSrc}/bootstrap-slider.min2.css" rel="stylesheet"/>
        <script src="{$auxFilesSrc}/bootstrap-slider.min2.js"></script>
