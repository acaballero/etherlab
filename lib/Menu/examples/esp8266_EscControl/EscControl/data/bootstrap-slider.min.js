      ...
      function e(b, c) {
        ...
        if (this.sliderElem) p = !0;
          ...
          (r.className = "slider-track"),
            ...
            (m.className = "slider-handle min2-slider-handle"),
            ...
            (n.className = "slider-handle max2-slider-handle"),
          ...
          (G.className = "tooltip tooltip-min2"),
            G.setAttribute("role", "presentation"),
            E(G);
          var H = document.createElement("div");
          (H.className = "tooltip tooltip-max2"),
        ...
        if (
          ...
          (this.tooltip_min = this.sliderElem.querySelector(".tooltip-min2")),
          (this.tooltipInner_min =
            this.tooltip_min.querySelector(".tooltip-inner")),
          (this.tooltip_max = this.sliderElem.querySelector(".tooltip-max2")),
      ...
      if (
        ...
        (d.prototype = {
          ...
          _offsetLeft: function (a) {
            return a.getBoundingClientqRect().left;
          },
