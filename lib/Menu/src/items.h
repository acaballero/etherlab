...
namespace Menu {
    ...
    public:
        ...
        inline prompt(constText *t, action a = doNothing, eventMask e = noEvent, styles s = noStyle,
    ...
    public:
        ...
        inline navTarget(constText *t, action a = doNothing, eventMask e = noEvent, styles s = noStyle,
                         systemStyles ss = _noStyle)
                : prompt(t, a, e, s, ss) {}
    ...
    public:
        ...
        inline menuNode(const char *text, idx_t sz, prompt *constMEM data[], action a = noAction, eventMask e = noEvent,
                        styles style = wrapStyle, systemStyles ss = (systemStyles) (_menuData | _canNav))
    ...
    public:
        ...
        inline menuVariant(constText *text, T &target, idx_t sz, prompt *constMEM *data, action a, eventMask e,
                           styles style)
