...
namespace Menu {
    ...
    public:
        ...
        prompt *constMEM *data;
    public:
        menuNodeShadow(const char *text, idx_t sz, prompt *constMEM *data, action a, eventMask e, styles style,
    ...
    public:
        ...
        fieldBaseShadow(constText *text, constText *units, action a = doNothing, eventMask e = noEvent,
                        styles s = noStyle,
    ...
    public:
        ...
        constMEM T low, high, step, tune;
    public:
        menuFieldShadow(T &value, constText *text, constText *units, T low, T high, T step, T tune,
                        action a = doNothing, eventMask e = noEvent, styles s = noStyle,
                        systemStyles ss = ((Menu::systemStyles) (Menu::_canNav | Menu::_parentDraw)))
                : fieldBaseShadow(text, units, a, e, s, ss), value(&value), low(low), high(high), step(step),
                  tune(tune) {}
