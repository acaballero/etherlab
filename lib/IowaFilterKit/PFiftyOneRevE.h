...
#include "CplxDMath.hpp"
 ...
 #define P51_MAXDEGREE   4       // The max poly order allowed. Used at the top of P51. This was set arbitrarily.
 #define P51_ARRAY_SIZE  6       // P51 uses the new operator. P51 arrays must be MaxDegree + 2
