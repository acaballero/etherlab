...
void i2cbitbang::conf_hardware(void) {
    ...
    if (i2cbbConfigTable[instance].GPIOclk_port == GPIOA ||
        i2cbbConfigTable[instance].GPIOdta_port == GPIOA)
        __HAL_RCC_GPIOA_CLK_ENABLE();
    if (i2cbbConfigTable[instance].GPIOclk_port == GPIOB ||
        i2cbbConfigTable[instance].GPIOdta_port == GPIOB)
        __HAL_RCC_GPIOB_CLK_ENABLE();
    if (i2cbbConfigTable[instance].GPIOclk_port == GPIOC ||
        i2cbbConfigTable[instance].GPIOdta_port == GPIOC)
        __HAL_RCC_GPIOC_CLK_ENABLE();
    if (i2cbbConfigTable[instance].GPIOclk_port == GPIOD ||
        i2cbbConfigTable[instance].GPIOdta_port == GPIOD)
        __HAL_RCC_GPIOD_CLK_ENABLE();
    if (i2cbbConfigTable[instance].GPIOclk_port == GPIOE ||
        i2cbbConfigTable[instance].GPIOdta_port == GPIOE)
        __HAL_RCC_GPIOE_CLK_ENABLE();
    if (i2cbbConfigTable[instance].GPIOclk_port == GPIOF ||
        i2cbbConfigTable[instance].GPIOdta_port == GPIOF)
