...
uint32_t i2cbitbang::getInstance(void) { return instance; }
ackMode_t i2cbitbang::getAckMode(void) { return ackMode; }

void i2cbitbang::setAckMode(ackMode_t ack) { ackMode = ack; }
...
void i2cbitbang::writeReg(uint8_t reg, uint8_t val) { writeData(reg, &val, 1); }
...
void i2cbitbang::readReg(uint8_t reg, uint8_t *pVal) { readData(reg, pVal, 1); }
...
i2cMode_t i2cbitbang::getI2CMode(void) { return i2cMode; }

void i2cbitbang::setI2CMode(i2cMode_t i2cm) { i2cMode = i2cm; }

uint32_t i2cbitbang::getError(void) { return error; }
